...
use Rostami\ShoppingCart\Contracts\Buyable;
use Illuminate\Contracts\Support\Jsonable;

/**
 * @property float|int|mixed|null $priceTax
 * @property float|int|mixed|null $total
 * @property float|int|mixed|null $subtotal
 * @property float|int|mixed|null $taxTotal
 * @property float|int|mixed|null $tax
 */
class CartItem implements Arrayable, Jsonable
{
     ...
     * @param int    $decimals
     * @param string $decimalPoint
    $thousandSeparator     * @return string
     */
    ...
    /**
     * Update the cart item from a buy-able item.
     *
     * @param Buyable $item
     * @return void
     */
